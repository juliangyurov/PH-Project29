...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createPlayers() {
        ...
        player1.position = CGPoint(x: player1Building.position.x, y: player1Building.position.y +
        ...
        player2.position = CGPoint(x: player2Building.position.x, y: player2Building.position.y +
